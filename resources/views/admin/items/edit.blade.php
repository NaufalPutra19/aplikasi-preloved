                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" name="price" class="form-control @error('price') is-invalid @enderror" 
                                   value="{{ old('price', $item->price) }}" required min="0" step="0.01">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" name="stock_min" class="form-control @error('stock_min') is-invalid @enderror" 
                                   value="{{ old('stock_min', $item->stock_min) }}" required min="0">
        ...
        <div class="col-lg-4">
            <div class="card mb-4">
                ...
                <div class="card-body text-center">
                    <img id="imagePreview" 
                         src="{{ $item->image ? asset('storage/'.$item->image) : 'https://via.placeholder.com/300x300?text=No+Image' }}" 
                         class="img-fluid rounded mb-3" style="max-height: 300px; object-fit: cover;" alt="Preview">
                    <input type="file" name="image" class="form-control @error('image') is-invalid @enderror" 
                           accept="image/*" onchange="previewImage(event)">
                    @error('image')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    <small class="text-muted d-block mt-2">Max 2MB (JPG, PNG). Leave empty to keep current image.</small>
                </div>
            </div>
